...
replace github.com/ethereum/go-ethereum => github.com/ethereum/go-ethereum v1.10.3

require github.com/urfave/cli/v2 v2.3.0

require (
	github.com/WilliamXieCrypto/chain-indexing v1.3.23
...
require (
	...
	github.com/crypto-org-chain/chain-main/v3 v3.3.3 // indirect
